...
# Features
 ...
 - **More information during gameplay**
	 - While you're playing, we show you information about how you're doing, such as your accuracy, miss count, health, and your grade/rating.
 ...
 - **More gameplay options**
	 - Want to play in a way different than other ways? We got you covered. Introducing Middlescroll (HEAVILY BROKE) and Crapscroll (SO BAD OMG ONLY WORKS IN DOWNSCROLL)
...
# Ratings!
 ...
 - Ehhh (20 - 35 Misses)
 - Bad (35 - 50 Misses)
 - Horrible (More than 50 misses)


This game was made with love to Newgrounds and its community. Extra love to Tom Fulp.
### Glitch Engine
- [Kitsuni](https://twitter.com/UltimateLeaksX) - Maintainer and lead programmer
